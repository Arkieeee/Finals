...
namespace Finals
{
    public partial class poloshirt : Form
    {
        private string _username;
        private int ProductId; // declare as class-level variable
        public poloshirt(string username)
        {
        ...
        {
            con.Open();
            SqlCommand com = new SqlCommand("Select Image_apparel as Item, Name as 'Description', Quantity, Price, Product_ID as 'Product ID' from Products where Category ='Polo Shirt'", con);
